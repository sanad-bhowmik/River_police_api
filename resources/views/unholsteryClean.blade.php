...
<body class="bg-white relative">
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://images.contentstack.io/v3/assets/blt0a0cb058815d4d96/blt4bba169f66c17a76/60e7453bf9afb12757e35ebf/Residential_Carpet_Cleaning_Page_resize.jpg?width=1920') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">UPHOLSTERY CLEANING</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Deep Clean / UPHOLSTERY CLEANING</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://proclean1.com.au/wp-content/uploads/2023/03/Professional-Upholstery-Cleaning-Services-couch-sofa-north-brisbane.jpg" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4">
                            <h4 class="text-xl font-bold text-white">
                                UPHOLSTERY EXPERTS
                            </h4>
                            <p class="text-md font-light mt-2 text-white">
                                UPHOLSTERY EXPERTS services include leak repairs, fixture installations, and maintenance for efficient water systems in homes and businesses, ensuring reliable operation and minimizing disruptions.
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <TS class="text-xl mb-1 font-semibold">UPHOLSTERY CLEANING EXPERTS</TS>
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP UPHOLSTERY CLEANING SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF UPHOLSTERY SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
                ...
                <div class="w-full px-4">
                    <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
                        <h2 class=" font-bold  text-3xl sm:text-4xl md:text-[40px] text-dark mb-4 ">
                            OUR FULL RANGE OF UPHOLSTERY CLEANING SERVICES INCLUDE
                        </h2>
                    </div>
                </div>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3 p-4 max-w-[400px] md:max-w-[600px] place-items-center">
                <img class="hover:opacity-75" src="https://causewaycleaning.com/wp-content/uploads/2024/02/istockphoto-487521402-612x612-1.webp">
                <img class="hover:opacity-75" src="https://cdn.images.express.co.uk/img/dynamic/51/590x/1420120_1.jpg">
                <img class="hover:opacity-75" src="https://www.thespruce.com/thmb/xhxBLm5gqH_YmZnGfPGcWBPZeHs=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/how-to-clean-velvet-furniture-5181302-Hero-ab2d2cc229e747199e2d2a87adbbcea1.jpg">
                <img class="hover:opacity-75" src="https://cdn.hg.eu/media/2qrpy3mn/how-to-remove-stains-from-a-sofa-01.jpg">
                <img class="hover:opacity-75" src="https://fastmaidservice.com/wp-content/uploads/2020/05/Upholstery-Cleaning.jpg">
                <img class="hover:opacity-75" src="https://www.fairprice.com.sg/wp-content/uploads/2021/05/How-to-clean-a-fabric-sofa-970x526.png">
            </div>
        </div>
    </section>
    <!-- ====== Pricing Section End -->
