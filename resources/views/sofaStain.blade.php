...
<body class="bg-white relative">
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://www.thespruce.com/thmb/LwdGa6WMqT5JSA9Eh-iXWo4JaAU=/5000x0/filters:no_upscale():max_bytes(150000):strip_icc()/how-to-clean-fabric-sofa-without-water-5214386-hero-3d09505bf37f43dea198cee5de12acc9.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">SOFA STAIN CLEANING</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Deep Clean / SOFA STAIN CLEANING</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://www.vanish.co.uk/static/68b1dc1d56fa8c6beb426df6098570f6/c482d/43fff4faa5e1588071419ab4bd5789bf14f6ac9d.jpg" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4">
                            <h4 class="text-xl font-bold text-white">
                                SOFA STAIN EXPERTS
                            </h4>
                            <p class="text-md font-light mt-2 text-white">
                                SOFA STAIN EXPERTS services include leak repairs, fixture installations, and maintenance for efficient water systems in homes and businesses, ensuring reliable operation and minimizing disruptions.
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <TS class="text-xl mb-1 font-semibold">SOFA STAIN CLEANING EXPERTS</TS>
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP SOFA STAIN CLEANING SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF SOFA STAIN CLEANING SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
    ...
    <section class="bg-white lg:pt-[120px] lg:ml-20 pb-12 lg:pb-[90px] relative z-20 overflow-hidden">
        <div class="container">
                ...
                <div class="w-full px-4">
                    <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
                        <h2 class=" font-bold  text-3xl sm:text-4xl md:text-[40px] text-dark mb-4 ">
                            OUR FULL RANGE OF SOFA STAIN CLEANING SERVICES INCLUDE
                        </h2>
                    </div>
                </div>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3 p-4 max-w-[400px] md:max-w-[600px] place-items-center">
                ...
                <img class="hover:opacity-75" src="https://www.localexpertcleaning.co.uk/wp-content/uploads/2021/09/Wolverhampton-sofa-cleaning-service.jpg">
