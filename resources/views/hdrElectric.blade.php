...
<body class="bg-white relative">
                        ...
                        <div class="absolute left-0 mt-1 bg-white shadow-lg rounded-lg p-2 hidden group-hover:block z-20" style="width: 340%;">
                            ...
                            <div class="relative group" onmouseover="showSubmenu6()" onmouseout="hideSubmenu6()">
                                ...
                                <div id="electric-submenu" class="absolute right-full top-0 mt-0 bg-white shadow-lg rounded-lg p-2 hidden-submenu z-20" style="width: 200px;">
                                    <a href="/electricalRepair" class="block px-4 py-2 hover:bg-gray-200">HDR Electrician Serviceation</a>
                                    <a href="/electricRepair" class="block px-4 py-2 hover:bg-gray-200">HDR Electrician Service</a>
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://www.ac-et.ie/wordpress/wp-content/uploads/2019/07/Services-ServicesRepairsTesting-hdr.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">HDR Electrician Service</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / HDR Electrician Service</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://media.licdn.com/dms/image/D5610AQF0W_g4Yo77AA/image-shrink_800/0/1718134381533?e=2147483647&v=beta&t=51qo-Ydjz-3cK-iIT5iCmz7jN36jmFvoczbn6YbQj4A" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4">
                            <h4 class="text-xl font-bold text-white">
                                HDR Electrician Service SERVICES
                            </h4>
                            <p class="text-md font-light mt-2 text-white">
                                HDR Electrician Service services include leak repairs, fixture Repairations, and maintenance for efficient water systems in homes and businesses, ensuring reliable operation and minimizing disruptions.
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">HDR Electrician Service EXPERTS</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our HDR Electrician Services have over 35 years of experience in the industry, serving 1000s of residential & commercial estates.
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP HDR Electrician Service SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our top-to-bottom HDR Electrician Service service is designed to be fuss-free for you. Besides having your Electrical fixtures repaired or replace.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF HDR Electrician Service SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our HDR Electrician Services carry out a comprehensive list of HDR Electrician Service works including clearing chokes, fixing leaks, water heater services.
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
                ...
                <div class="w-full px-4">
                    <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
                        <h2 class=" font-bold  text-3xl sm:text-4xl md:text-[40px] text-dark mb-4 ">
                            OUR FULL RANGE OF HDB ELECTRICIAN SERVICES INCLUDE
                        </h2>
                    </div>
                </div>
            </div>
    ...
    <section class="bg-white mt-4">
        <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4">
                <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
                    <h2 class=" font-bold  text-3xl sm:text-4xl md:text-[40px] text-dark mb-4 ">
                        OUR COMPLETED HDR Electrician Service
                    </h2>
                </div>
            </div>
        </div>
    ...
    <div class="py-24 px-8 max-w-5xl mx-auto flex flex-col md:flex-row gap-12 mt-10">
        ...
        <ul class="basis-1/2">
            <li>
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden" style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed">Whether it comes to broken pipes, leaky faucets, or clogged drains, it is best to call up a professional Singapore HDR Electrician Service who has the license, skills, tools and expertise to deal with the task. Here are some things to consider before looking to engage a HDR Electrician Service.
                            License / Accreditations
                            A PUB license is important for big plumbing projects, especially for HDB or commerciarenovations that require hacking into the plumbing systems. However, most HDR Electrician Services should bBCA-licensed for common domestic plumbing works like solving water leaks and water pipe works.
                            Experience
                            Looking for an experienced HDR Electrician Service is key if you do not want the plumbing issue they are fixinto come back again. A HDR Electrician Service who is confident in their skills is equivalent to how many yearthey have been working in the industry.
                            ...
                            Warranty
                            Look at Singapore HDR Electrician Service services that offers plumbing works with workmanship or servicwarranty, and check if the warranty is extended to the plumbing products as well.
                        </div>
                    </div>
                </div>
            </li>
            <li>
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden" style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed">Plumbing emergencies do happen, and calling a HDR Electrician Service will be necessary. But you can certainly save money on plumbing works by preventing them from disrepair in the first place. Just follow these easy steps:
                            ...
                            Compare prices
                            Plumbing is a competitive business, and many different companies offer different plumbing services at differing prices. Make sure you do your own research in order to compare prices and find the right HDR Electrician Service who can do the job well for you.</div>
                    </div>
                </div>
            </li>
            <li>
