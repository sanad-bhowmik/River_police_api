...
<body class="bg-white relative">
    ...
    <header>
        <nav id="nav1" x-data="{ open: false }" class="flex h-auto w-auto bg-white rounded-lg justify-between md:h-16" style="box-shadow: rgba(0, 0, 0, 0.35) 0rem .3125rem .9375rem;">
            <div class="flex w-full justify-between">
                ...
                <div class="hidden w-2/5 items-center justify-evenly font-semibold md:flex relative z-10">
                    <a href="/">Home</a>
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://www.checkatrade.com/blog/wp-content/uploads/2021/01/How-to-lay-decking.jpg') no-repeat center center fixed; background-size: cover; height: 18.75rem;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 16px; padding-right: 16px; text-align: center; gap: 16px;">
            <h1 style="font-size: 40px; color: white; font-weight: 100; margin-bottom: 24px;">SEARCH RESULT FOR DECKING</h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div id="cardContainer" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="card max-w-sm bg-white shadow-lg rounded-lg overflow-hidden" style="border-bottom:3px solid #f7a80c;">
                    <img class="w-full h-48 object-cover" src="https://www.realwoodflooring-manchester.co.uk/resources/images/service-1.jpg" alt="Card Image">
                    <div class="p-6 text-center">
                        <h3 class="text-lg font-medium text-gray-900 mb-2">Decking is a term that can be applied to numerous applications in construction. It means building a structure with deck cover.</h3>
                ...
                <!-- Card 2 -->
                <div class="card max-w-sm bg-white shadow-lg rounded-lg overflow-hidden" style="border-bottom:3px solid #f7a80c;">
                    <img class="w-full h-48 object-cover" src="https://coffshardwoods.com.au/wp-content/uploads/2019/10/Decking-Internal-gallery5-1570x900.jpg" alt="Card Image">
                    <div class="p-6 text-center">
                        <h3 class="text-lg font-medium text-gray-900 mb-2">If you are looking for professional Timber Decking services, do not hesitate to contact us.</h3>
                        <button class="bg-yellow-500 text-black px-2 py-2 rounded hover:bg-yellow-200 ">Read More > </button>
                    </div>
                    <div class="flex ml-20 mb-6">
                        <div class="text-gray-600 flex">
                ...
                <!-- Card 3 -->
                <div class="card max-w-sm bg-white shadow-lg rounded-lg overflow-hidden" style="border-bottom:3px solid #f7a80c;">
                    <img class="w-full h-48 object-cover" src="https://neotimber.com/decking/wp-content/uploads/sites/5/2020/11/NeoTimber-Composite-Decking-Balcony.jpg" alt="Card Image">
                    <div class="p-6 text-center">
                        <h3 class="text-lg font-medium text-gray-900 mb-2">If you are looking for professional Balcony Decking services, do not hesitate to contact us.</h3>
                        <button class="bg-yellow-500 text-black px-2 py-2 rounded hover:bg-yellow-200 ">Read More > </button>
                    </div>
                    <div class="flex ml-20 mb-6">
                        <div class="text-gray-600 flex">
        ...
        <div class="max-w-sm mx-auto p-4 bg-white rounded-lg shadow-md mt-8">
            ...
            <div>
                ...
                <ul>
                    <li class=" flex justify-between py-1 border-b">
                        <span><span style="font-weight: 900;">-</span> Decking</span>
                        <span class="text-gray-500 bg-gray-100 p-1 rounded-lg w-8 text-center">115</span>
                    </li>
                    <ul class="ml-4">
                        <li class="flex justify-between py-1 border-b">
                            <span><span style="font-weight: 900;">-</span> Timber Decking</span>
                            <span class="text-gray-500 bg-gray-100 p-1 rounded-lg w-8 text-center">121</span>
                        </li>
                        <li class="flex justify-between py-1 border-b">
                            <span><span style="font-weight: 900;">-</span> Balcony Decking</span>
            ...
            <div class="max-w-sm mx-auto p-4 bg-white rounded-lg shadow-md mt-10">
                ...
                <div class="grid grid-cols-3 gap-2 border-top">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgNebPtiUH6J9Xfq6fPZwpzr04P4mdlNg59w&s" alt="Portfolio Image 1" style="width: 100px; height: 80px; object-fit: cover;" class="rounded-lg shadow-sm">
                    <img src="https://www.shutterstock.com/image-photo/woodworker-refreshing-wooden-floor-workers-600nw-2350507659.jpg" alt="Portfolio Image 2" style="width: 100px; height: 80px; object-fit: cover;" class="rounded-lg shadow-sm">
                    <img src="https://www.shutterstock.com/image-photo/wooden-deck-sanding-power-sander-600nw-2384697837.jpg" alt="Portfolio Image 3" style="width: 100px; height: 80px; object-fit: cover;" class="rounded-lg shadow-sm">
                    <img src="https://media.istockphoto.com/id/1167029364/photo/cleaning-terrace-with-a-power-washer-high-water-pressure-cleaner-on-wooden-terrace-surface.jpg?s=612x612&w=0&k=20&c=t6jADq0Bn1JrdPJdFLjgodgx20wsYfDX3bFRv__RB4c=" alt="Portfolio Image 4" style="width: 100px; height: 80px; object-fit: cover;" class="rounded-lg shadow-sm">
                    <img src="https://www.shutterstock.com/image-photo/wood-deck-renovation-treatment-person-600nw-1944042019.jpg" alt="Portfolio Image 5" style="width: 100px; height: 80px; object-fit: cover;" class="rounded-lg shadow-sm">
                    <img src="https://deckready.net/app/wp-content/themes/deck-ready/demo/inspections/images/img-service-thumb1.jpg" alt="Portfolio Image 6" style="width: 100px; height: 80px; object-fit: cover;" class="rounded-lg shadow-sm">
                    <img src="https://africandecks.co.za/wp-content/uploads/2016/12/IMG-20150521-WA0014-1024x768.jpg" alt="Portfolio Image 7" style="width: 100px; height: 80px; object-fit: cover;" class="rounded-lg shadow-sm">
                    <img src="https://photos-eu.bazaarvoice.com/photo/2/cGhvdG86YnVubmluZ3Mtbno/87591344-2c0c-57a2-819a-6905d2e95246" alt="Portfolio Image 8" style="width: 100px; height: 80px; object-fit: cover;" class="rounded-lg shadow-sm">
                    <img src="https://media.istockphoto.com/id/500876640/photo/wooden-decking-construction.jpg?s=612x612&w=0&k=20&c=_gPSlvyB7p4kQttlEllgtDCkNh-GE07tb4YUK0Hzzrk=" alt="Portfolio Image 9" style="width: 100px; height: 80px; object-fit: cover;" class="rounded-lg shadow-sm">
                    <img src="https://deckready.net/app/wp-content/themes/deck-ready/demo/repair/images/img-our-work-thumb4.jpg" alt="Portfolio Image 10" style="width: 100px; height: 80px; object-fit: cover;" class="rounded-lg shadow-sm">
                    <img src="https://media.istockphoto.com/id/1174252791/photo/staining-wooden-deck-with-paint-roller.jpg?s=612x612&w=0&k=20&c=KUrUM4E_K7o1cdbMyLhhnuZBTRA3txqFpCkRKpQFydw=" alt="Portfolio Image 11" style="width: 100px; height: 80px; object-fit: cover;" class="rounded-lg shadow-sm">
                </div>
            </div>
