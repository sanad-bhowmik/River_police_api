...
<body class="bg-white relative">
                        ...
                        <div class="absolute left-0 mt-1 bg-white shadow-lg rounded-lg p-2 hidden group-hover:block z-20" style="width: 340%;">
                            ...
                            <div class="relative group" onmouseover="showSubmenu2()" onmouseout="hideSubmenu2()">
                                <a href="/floorclean" class="flex items-center px-4 py-2 hover:bg-gray-200">
                                    <span class="ml-1">Pipe Line Install</span>
                                </a>
                                <div id="fClean-submenu" class="absolute right-full top-0 mt-0 bg-white shadow-lg rounded-lg p-2 hidden-submenu z-20" style="width: 12.5rem;">
                                    ...
                                    <a href="/vinylClean" class="block px-4 py-2 hover:bg-gray-200">Pipe Line Installing</a>
                                    <a href="/vinylFloorClean" class="block px-4 py-2 hover:bg-gray-200">Vinyl Pipe Line Install</a>
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://thumbor.forbes.com/thumbor/fit-in/x/https://www.forbes.com/home-improvement/wp-content/uploads/2022/09/featured_image_how_much_does_gas_line_installation_cost.jpeg.jpg') no-repeat center center fixed; background-size: cover; height: 18.75rem;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 16px; padding-right: 16px; text-align: center; gap: 16px;">
            <h1 style="font-size: 40px; color: white; font-weight: 100; margin-bottom: 24px;">Pipe Line Install</h1>
            <p style="font-size: 16px; color: antiquewhite;">Home / Service / Plumbing / Pipe Line Install</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://www.energyvanguard.com/wp-content/uploads/2022/07/hot-water-retrofit-manifold.jpeg" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4">
                            <h4 class="text-xl font-bold text-white">
                                Pipe Line Install
                            </h4>
                            <p class="text-md font-light mt-2 text-white">
                                Pipe Line Install services include leak repairs, fixture Leakations, and maintenance for efficient water systems in homes and businesses, ensuring reliable operation and minimizing disruptions.
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <TS class="text-xl mb-1 font-semibold">Pipe Line Install EXPERTS</TS>
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP Pipe Line Install SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our top-to-bottom Pipe Line Install service is designed to be fuss-free for you. Besides having your floor cleaned, we also ensure that you have a clear understanding of our Pipe Line Install process, enabling you to apply the knowledge to maintain the cleanliness of your floors.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF Pipe Line Install SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our Pipe Line Install servicing technicians carry out a comprehensive list of Pipe Line Install works including floor deep cleaning, vinyl Pipe Line Install.
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
                ...
                <div class="w-full px-4">
                    <div class="text-center mx-auto mb-[3.75rem] lg:mb-20 max-w-[31.875rem]">
                        <h2 class=" font-bold  text-3xl sm:text-4xl md:text-[2.5rem] text-dark mb-4 ">
                            OUR FLOOR PipeE INSTALL PROCESS
                        </h2>
                    </div>
                </div>
            </div>
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden" style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed">Plumbing Services start from $90 per job. See here for full list of our plumbing services prices.
                            ...
                            Pipe Line Installs Services
                            Pipe Line Install Services
                            Pipe Line Install Services
                            Toilet Flush System Services
                            Pipe Line Installs</div>
                    </div>
                </div>
            </li>
        </ul>
