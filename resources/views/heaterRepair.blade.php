...
<body class="bg-white relative">
                        ...
                        <div class="absolute left-0 mt-1 bg-white shadow-lg rounded-lg p-2 hidden group-hover:block z-20" style="width: 340%;">
                            ...
                            <div class="relative group" onmouseover="showSubmenu2()" onmouseout="hideSubmenu2()">
                                <a href="/floorclean" class="flex items-center px-4 py-2 hover:bg-gray-200">
                                    <span class="ml-1">Water Leak Repair</span>
                                </a>
                                <div id="fClean-submenu" class="absolute right-full top-0 mt-0 bg-white shadow-lg rounded-lg p-2 hidden-submenu z-20" style="width: 12.5rem;">
                                    <a href="/floorclean" class="block px-4 py-2 hover:bg-gray-200">Floor Deep Cleaning</a>
                                    <a href="/vinylClean" class="block px-4 py-2 hover:bg-gray-200">Water Leak Repairing</a>
                                    <a href="/vinylFloorClean" class="block px-4 py-2 hover:bg-gray-200">Vinyl Water Leak Repair</a>
                            ...
                            <div class="relative group" onmouseover="showSubmenu1()" onmouseout="hideSubmenu1()">
                                ...
                                <div id="varnish-submenu" class="absolute right-full top-0 mt-0 bg-white shadow-lg rounded-lg p-2 hidden-submenu z-20" style="width: 12.5rem;">
                            ...
                            <div class="relative group" onmouseover="showSubmenu()" onmouseout="hideSubmenu()">
                                ...
                                <div id="decking-submenu" class="absolute right-full top-0 mt-0 bg-white shadow-lg rounded-lg p-2 hidden-submenu z-20" style="width: 12.5rem;">
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://www.everyworks.com/wp-content/uploads/2020/05/water-heater-repair-everyworks-plumber-singapore_wm-390x220.jpg') no-repeat center center Repaired; background-size: cover; height: 18.75rem;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 16px; padding-right: 16px; text-align: center; gap: 16px;">
            <h1 style="font-size: 40px; color: white; font-weight: 100; margin-bottom: 24px;">Water Leak Repair</h1>
            <p style="font-size: 16px; color: antiquewhite;">Home / Service / Plumbing / Water Leak Repair</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://www.wickedplumbing.com/site/wp-content/uploads/water-heater-repair-copy.jpg" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4">
                            <h4 class="text-xl font-bold text-white">
                                Water Leak Repair
                            </h4>
                            <p class="text-md font-light mt-2 text-white">
                                Water Leak Repair services include leak repairs, Repairture Leakations, and maintenance for efficient water systems in homes and businesses, ensuring reliable operation and minimizing disruptions.
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <TS class="text-xl mb-1 font-semibold">Water Leak Repair EXPERTS</TS>
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP Water Leak Repair SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our top-to-bottom Water Leak Repair service is designed to be fuss-free for you. Besides having your floor cleaned, we also ensure that you have a clear understanding of our Water Leak Repair process, enabling you to apply the knowledge to maintain the cleanliness of your floors.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF Water Leak Repair SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our Water Leak Repair servicing technicians carry out a comprehensive list of Water Leak Repair works including floor deep cleaning, vinyl Water Leak Repair.
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
            ...
            <div class="flex flex-wrap justify-center -mx-4">
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://www.wickedplumbing.com/site/wp-content/uploads/water-heater-repair-copy.jpg" alt="" class="ml-14 mb-10" style="border: .0625rem solid #f7a80c;padding: .625rem;height: 11.875rem;">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://morningsideplumbing.com/wp-content/uploads/2023/02/Water-Heater-Repair-Atlanta.jpg" alt="" class="ml-14 mb-10" style="border: .0625rem solid #f7a80c;padding: .625rem;height: 11.875rem;">
                        <span class="text-primary font-semibold text-lg block mb-4">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://ehretco.com/wp-content/uploads/2022/10/4-Reasons-Water-Heater-Repair-Replacement-May-Improve-Your-Familys-Health-water-heater-repair-replacement-Ehret-Plumbing-Heating-800x600.jpg" alt="" class="ml-14 mb-10" style="border: .0625rem solid #f7a80c;padding: .625rem;height: 11.875rem;">
                        <span class="text-primary font-semibold text-lg block mb-4">
            ...
            <li>
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden" style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed">Whether it comes to broken Pipees, leaky faucets, or clogged drains, it is best to call up a professional Singapore plumber who has the license, skills, tools and expertise to deal with the task. Here are some things to consider before looking to engage a plumber.
                            License / Accreditations
                            A PUB license is important for big plumbing projects, especially for HDB or commerciarenovations that require hacking into the plumbing systems. However, most plumbers should bBCA-licensed for common domestic plumbing works like solving water leaks and water Pipee works.
                            Experience
                            Looking for an experienced plumber is key if you do not want the plumbing issue they are Repairinto come back again. A plumber who is confident in their skills is equivalent to how many yearthey have been working in the industry.
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden" style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed">Plumbing Services start from $90 per job. See here for full list of our plumbing services prices.
                            ...
                            Water Leak Repairation Services
                            Water Leak Repairs Services
                            Water Leak Repair Services
                            Water Leak Repair Services
                            Toilet Flush System Services
                            Water Leak Repairs</div>
                    </div>
                </div>
            </li>
        </ul>
...
<script>
    ...
    window.onscroll = function() {
        ...
        if (window.pageYOffset > 0) {
            ...
            navbar.style.position = "Repaired";
            navbar.style.top = "0";
