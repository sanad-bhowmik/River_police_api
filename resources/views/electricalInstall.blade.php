...
<body class="bg-white relative">
                        ...
                        <div class="absolute left-0 mt-1 bg-white shadow-lg rounded-lg p-2 hidden group-hover:block z-20" style="width: 340%;">
                            ...
                            <div class="relative group" onmouseover="showSubmenu6()" onmouseout="hideSubmenu6()">
                                ...
                                <div id="electric-submenu" class="absolute right-full top-0 mt-0 bg-white shadow-lg rounded-lg p-2 hidden-submenu z-20" style="width: 200px;">
                                    <a href="/electricalInstall" class="block px-4 py-2 hover:bg-gray-200">Electrical Installation</a>
                                    <a href="/electricRepair" class="block px-4 py-2 hover:bg-gray-200">Electrical Repair</a>
                                    ...
                                    <a href="/tvBucket" class="block px-4 py-2 hover:bg-gray-200">TV Bracket Installation</a>
                                    <a href="/wallMounting" class="block px-4 py-2 hover:bg-gray-200">Wall Mounting Installation</a>
                                    <a href="/pullUp" class="block px-4 py-2 hover:bg-gray-200">PullUp Bar Installation</a>
                                </div>
                            </div>
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://www.coynecollege.edu/wp-content/uploads/2020/06/Learn-the-Basics-of-Home-Electrical-Wiring-CoyneCollege-scaled.jpeg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">Electrical Install</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Electrical Install</p>
        </div>
    </section>
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        ...
                        <blockquote class="relative p-8 mb-4">
                            ...
                            <p class="text-md font-light mt-2 text-white">
                                Electrical Install services include leak repairs, fixture installations, and maintenance for efficient water systems in homes and businesses, ensuring reliable operation and minimizing disruptions.
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">Electrical Install EXPERTS</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our Electrical Installs have over 35 years of experience in the industry, serving 1000s of residential & commercial estates.
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP Electrical Install SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our top-to-bottom Electrical Install service is designed to be fuss-free for you. Besides having your Electrical fixtures repaired or replace.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF Electrical Install SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our Electrical Installs carry out a comprehensive list of Electrical Install works including clearing chokes, fixing leaks, water heater services.
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
    ...
    <section class="bg-white lg:pt-[120px] pb-12 lg:pb-[90px] relative z-20 overflow-hidden">
        <div class="container">
            <div class="flex flex-wrap -mx-4 lg:ml-32">
                <div class="w-full px-4">
                    <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
                        <h2 class=" font-bold  text-3xl sm:text-4xl md:text-[40px] text-dark mb-4 ">
                            OUR FULL RANGE OF Electrical Install SERVICES INCLUDE
                        </h2>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-wrap justify-center -mx-4">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1" style="height: 99%;">
                        <span class="text-primary font-semibold text-lg block mb-4">
                            Power Trip / Power Failure
                        </span>
                        <hr>
                        <div class="mb-7">
                            <p class="text-base text-body-color leading-loose mb-1">
                                Electrical Distribution Board Installation (DB Box)
                            </p>
                            <p class="text-base text-body-color leading-loose mb-1">
                                Electric Panel / Electric Board
                            </p>
                            <p class="text-base text-body-color leading-loose mb-1">
                                Circuit Breaker Services
                            </p>
                            <p class="text-base text-body-color leading-loose mb-1">
                                Miniature Circuit Breaker (MCB) Services
                            </p>
                            <p class="text-base text-body-color leading-loose mb-1">
    ...
    <section class="bg-white mt-4">
        <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4">
                <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
                    <h2 class=" font-bold  text-3xl sm:text-4xl md:text-[40px] text-dark mb-4 ">
                    OUR COMPLETED ELECTRICAL WORKS
                    </h2>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 h-full">
                <div class="col-span-2 sm:col-span-1 md:col-span-2 bg-gray-50 h-auto md:h-full flex flex-col">
                    <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 flex-grow">
                        <img src="https://media.istockphoto.com/id/1345765714/photo/electrical-engineers-test-electrical-installations-and-wiring-on-protective-relays-measuring.jpg?s=612x612&w=0&k=20&c=Go95zj7drMZVNTaPS615U5Yjsl_y1cvTHqoyJirLMlA=" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                        <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                    </a>
                </div>
                <div class="col-span-2 sm:col-span-1 md:col-span-2 bg-stone-50">
                    <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 mb-4">
                        <img src="https://www.designblendz.com/hs-fs/hubfs/AdobeStock_305069681.jpeg?width=750&name=AdobeStock_305069681.jpeg" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                        <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                    </a>
                    <div class="grid gap-4 grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
                        <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40">
                            <img src="https://raviniaplumbing.com/wp-content/uploads/2022/08/Ravinia_Electric.png.webp" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                            <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                        </a>
                        <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40">
                            <img src="https://www.equans-digital.com/sites/g/files/tkmtob241/files/styles/coh_x_large/public/2023-07/electricit%C3%A9_0.PNG?itok=Gyo9fW61" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
                            <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                        </a>
                    </div>
                </div>
    ...
    <div class="py-24 px-8 max-w-5xl mx-auto flex flex-col md:flex-row gap-12 mt-10">
        ...
        <ul class="basis-1/2">
            <li>
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden" style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed">Whether it comes to broken pipes, leaky faucets, or clogged drains, it is best to call up a professional Singapore Electrical Install who has the license, skills, tools and expertise to deal with the task. Here are some things to consider before looking to engage a Electrical Install.
                            License / Accreditations
                            A PUB license is important for big plumbing projects, especially for HDB or commerciarenovations that require hacking into the plumbing systems. However, most Electrical Installs should bBCA-licensed for common domestic plumbing works like solving water leaks and water pipe works.
                            Experience
                            Looking for an experienced Electrical Install is key if you do not want the plumbing issue they are fixinto come back again. A Electrical Install who is confident in their skills is equivalent to how many yearthey have been working in the industry.
                            ...
                            Warranty
                            Look at Singapore Electrical Install services that offers plumbing works with workmanship or servicwarranty, and check if the warranty is extended to the plumbing products as well.
                        </div>
                    </div>
                </div>
            </li>
            <li>
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden" style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed">Plumbing emergencies do happen, and calling a Electrical Install will be necessary. But you can certainly save money on plumbing works by preventing them from disrepair in the first place. Just follow these easy steps:
                            ...
                            Compare prices
                            Plumbing is a competitive business, and many different companies offer different plumbing services at differing prices. Make sure you do your own research in order to compare prices and find the right Electrical Install who can do the job well for you.</div>
                    </div>
                </div>
            </li>
            <li>
