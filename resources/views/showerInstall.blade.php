...
<body class="bg-white relative">
                        ...
                        <div class="absolute left-0 mt-1 bg-white shadow-lg rounded-lg p-2 hidden group-hover:block z-20" style="width: 340%;">
                            ...
                            <div class="relative group" onmouseover="showSubmenu2()" onmouseout="hideSubmenu2()">
                                <a href="/floorclean" class="flex items-center px-4 py-2 hover:bg-gray-200">
                                    <span class="ml-1">Shower Install</span>
                                </a>
                                <div id="fClean-submenu" class="absolute right-full top-0 mt-0 bg-white shadow-lg rounded-lg p-2 hidden-submenu z-20" style="width: 200px;">
                                    ...
                                    <a href="/vinylClean" class="block px-4 py-2 hover:bg-gray-200">Shower Installing</a>
                                    <a href="/vinylFloorClean" class="block px-4 py-2 hover:bg-gray-200">Vinyl Shower Install</a>
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://www.bathwraps.com/wp-content/uploads/2020/10/bigstock-Plumber-Installing-Shower-Stal-362489848.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">Shower Install</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Floor Clean / Shower Install</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://superiorplumbing.ca/wp-content/uploads/2022/12/Shower-install.jpg" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4">
                            <h4 class="text-xl font-bold text-white">
                                Shower Install
                            </h4>
                            <p class="text-md font-light mt-2 text-white">
                                Shower Install services include leak repairs, fixture Choke'sations, and maintenance for efficient water systems in homes and businesses, ensuring reliable operation and minimizing disruptions.
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <TS class="text-xl mb-1 font-semibold">Shower Install EXPERTS</TS>
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP Shower Install SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our top-to-bottom Shower Install service is designed to be fuss-free for you. Besides having your floor cleaned, we also ensure that you have a clear understanding of our Shower Install process, enabling you to apply the knowledge to maintain the cleanliness of your floors.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF Shower Install SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our Shower Install servicing technicians carry out a comprehensive list of Shower Install works including floor deep cleaning, vinyl Shower Install.
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
            ...
            <div class="flex flex-wrap justify-center -mx-4">
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://superiorplumbing.ca/wp-content/uploads/2022/12/Shower-install.jpg" alt="" class="ml-14 mb-10" style="border: 1px solid #f7a80c;padding: 10px;height: 190px;">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://www.bathwraps.com/wp-content/uploads/2020/10/bigstock-Plumber-Installing-Shower-Stal-362489848.jpg" alt="" class="ml-14 mb-10" style="border: 1px solid #f7a80c;padding: 10px;height: 190px;">
                        <span class="text-primary font-semibold text-lg block mb-4">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://media.product.which.co.uk/prod/images/ar_2to1_1500x750/055d205ef010-51bathroom-installation.jpg" alt="" class="ml-14 mb-10" style="border: 1px solid #f7a80c;padding: 10px;height: 190px;">
                        <span class="text-primary font-semibold text-lg block mb-4">
