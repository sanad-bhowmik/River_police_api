...
<body class="bg-white relative">
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://www.modahardware-gm.com/images/thumbs/0000396_uplift.jpeg') no-repeat center center fixed; background-size: cover; height: 300px;">
