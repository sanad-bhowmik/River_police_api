...
<body class="bg-white relative">
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://media.istockphoto.com/id/1413738042/video/textures-and-pattern-of-ceramic-granite-tiles-with-a-surface-imitating-wooden-boards.jpg?s=640x640&k=20&c=E73lBfZADLnZYG3O7vuYZlLSchE_aKehNF4WMH_mcEs=') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">PARQUET POLISHING</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Floor Polishing / PARQUET POLISHING</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://floorpolishingco.com/wp-content/uploads/2020/12/repair-scratches-on-the-parquet-2.jpg" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4">
                            <h4 class="text-xl font-bold text-white">
                                PARQUET POLISHING
                            </h4>
                            <p class="text-md font-light mt-2 text-white">
                                PARQUET POLISHING consists of applying a protective film to the wood. The application of several layers of film-forming product will create a protective film, which makes your floor resistant to most accidents .
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">PARQUET POLISHING EXPERTS</h6>
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP PARQUET POLISHING SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our top-to-bottom parquet polishing service is designed to be fuss-free for you. Besides providing the parquet polishing service, we can also supply the polishing products and equipment required for the service!
                                    </p>
                                </div>
                            </div>
                        </div>
