...
<body>
    ...
    <section class="p-4">
        <div class="mt-20 relative mx-auto" style="max-width: 35.625rem; padding: 1.125rem; border-right: .1875rem solid rgba(0,85,255,1); border-left: .1875rem solid rgba(0,85,255,1);">
            <h1 class="text-center text-2xl md:text-4xl" style="text-shadow: .125rem .4375rem .3125rem rgba(0,0,0,0.3), 0rem -0.25rem .625rem rgba(255,255,255,0.3);">PPH M&E Ltd PRICING GUIDE</h1>
        ...
        <div class="max-w-3xl mx-auto mt-10">
            <p class="text-center text-base md:text-lg text-gray-600">Our price guide list is shown in the table below. Please message us via Whatsapp at <span class="text-blue-500">+65 6575 1226</span> for accurate and transparent quote for our home services. Here at PPH M&E Ltd Services, we strive to offer honest and upfront quotation at the best competitive prices. Prices quoted are for works done by our team of highly experienced professional technicians.</p>
        ...
        <div class="mt-10 mb-6">
            <p class="text-center text-base font-semibold text-gray-600"><span class="underline">PPH M&E Ltd Services Price List</span> <br> (click on service category to price list section)</p>
    ...
    <section class="relative overflow-x-auto ml-36 mb-10 mt-20" id="#Plumbing">
        ...
        <table class="w-full text-base text-center rtl:text-right text-gray-500 dark:text-gray-400" style="width: 90%;">
            <thead class="text-lg text-gray-700 uppercase dark:text-gray-400 border border-gray-300 dark:border-gray-700">
                <tr>
                    <th scope="col" class="px-6 py-3 bg-yellow-500 dark:bg-gray-800">
                        Item
                    </th>
            ...
            <tbody>
                <tr class="border-b border-gray-300 dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-yellow-500 dark:text-white dark:bg-gray-800">1</th>
                    <td class="px-6 py-4">
                ...
                <tr class="border-b border-gray-300 dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-yellow-500 dark:text-white dark:bg-gray-800">2</th>
                    <td class="px-6 py-4">
                ...
                <tr class="border-b border-gray-300 dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-yellow-500 dark:text-white dark:bg-gray-800">3</th>
                    <td class="px-6 py-4">
                ...
                <tr class="border-b border-gray-300 dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-yellow-500 dark:text-white dark:bg-gray-800">4</th>
                    <td class="px-6 py-4">
                ...
                <tr class="border-b border-gray-300 dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-yellow-500 dark:text-white dark:bg-gray-800">5</th>
                    <td class="px-6 py-4">
                ...
                <tr class="border-b border-gray-300 dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-yellow-500 dark:text-white dark:bg-gray-800">6</th>
                    <td class="px-6 py-4">
                        Replace shower set
                    </td>
                    <td class="px-6 py-4 dark:bg-gray-800">
    ...
    <section class="relative overflow-x-auto ml-36 mb-10 mt-20" id="#AIRCON">
        ...
        <table class="w-full text-base text-center rtl:text-right text-gray-500 dark:text-gray-400" style="width: 90%;">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-300 dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-yellow-500 dark:text-white dark:bg-gray-800">7</th>
