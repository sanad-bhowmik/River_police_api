...
<body class="bg-white relative">
                        ...
                        <div class="absolute left-0 mt-1 bg-white shadow-lg rounded-lg p-2 hidden group-hover:block z-20" style="width: 340%;">
                            ...
                            <div class="relative group" onmouseover="showSubmenu()" onmouseout="hideSubmenu()">
                                <a href="/decking" class="flex items-center px-4 py-2 hover:bg-gray-200">
                                    <span class="hidden group-hover:inline">&lt;</span> <!-- Add this line for the icon -->
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://cdnassets.hw.net/a4/30/2b6b1efc4bdb9b7ce0e1186929fc/balcony-15-crop.JPG') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">Balcony Decking</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Decking / Balcony Decking</p>
        </div>
    </section>
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        ...
                        <blockquote class="relative p-8 mb-4">
                            ...
                            <p class="text-md font-light mt-2 text-white">
                                Our balcony composite decking boards ensure structural integrity, longevity & great looks that make them the perfect solution for decked balcony projects.
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">BALCONY DECKING EXPERTS</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        If you are looking for professional Balcony Decking services, do not hesitate to contact us. We will provide recommendations based on your needs.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <p class="mb-4 text-blueGray-500">
                                        Every house is different, and we will recommend what is best based on your space. Our experienced team will suggest the best course of action to take so that you can achieve your desired flooring.
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
                    ...
                    <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
                        <div class="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col justify-center items-center max-w-sm mx-auto">
                            ...
                            <div class=" w-70 bg-white -mt-10 shadow-lg rounded-lg overflow-hidden p-5">
                                <div class="title-post font-medium text-center" style="font-size: 24px;font-weight: 800;margin-bottom: 16px;">Balcony Decking Installation</div>

                                <div class="summary-post text-base text-justify">Installing balcony decking not only enlarges the living area and provides a spot for relaxation or hosting guests, but it also serves as a safeguard against weather-related damage to the balcony. Opting for the expertise of professional services for balcony decking installation is strongly advised to ensure quality and safety.
                                </div>
                        ...
                        <div class="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col justify-center items-center max-w-sm mx-auto">
                            ...
                            <div class=" w-70 bg-white -mt-10 shadow-lg rounded-lg overflow-hidden p-5">
                                <div class="title-post font-medium text-center" style="font-size: 24px;font-weight: 800;margin-bottom: 16px;">Balcony Decking Replacement</div>
                                <div class="summary-post text-base text-justify">Do you have damaged sections on your balcony decking? If you aim to restore the beauty and elegance of your balcony by replacing the decking, it is strongly advised to enlist the services of professional balcony decking replacement experts. This ensures a thorough and seamless replacement process.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col justify-center items-center max-w-sm mx-auto">
                            ...
                            <div class=" w-70 bg-white -mt-10 shadow-lg rounded-lg overflow-hidden p-5">
                                <div class="title-post font-medium text-center" style="font-size: 24px;font-weight: 800;margin-bottom: 16px;">Balcony Decking Repair</div>
                                <div class="summary-post text-base text-justify">As time passes, the charm of your balcony may diminish, necessitating repairs. In such situations, it is recommended to explore the option of hiring professional services for balcony decking repair, ensuring top-notch workmanship and effective repair solutions.
                                </div>
                            </div>
                        </div>
                    </div>
