...
<body class="bg-white relative">
                        ...
                        <div class="absolute left-0 mt-1 bg-white shadow-lg rounded-lg p-2 hidden group-hover:block z-20" style="width: 340%;">
                            ...
                            <div class="relative group" onmouseover="showSubmenu2()" onmouseout="hideSubmenu2()">
                                <a href="/floorclean" class="flex items-center px-4 py-2 hover:bg-gray-200">
                                    <span class="ml-1">COMMERCIAL PLUMBER Service</span>
                                </a>
                                <div id="fClean-submenu" class="absolute right-full top-0 mt-0 bg-white shadow-lg rounded-lg p-2 hidden-submenu z-20" style="width: 12.5rem;">
                                    ...
                                    <a href="/vinylClean" class="block px-4 py-2 hover:bg-gray-200">COMMERCIAL PLUMBER Serviceing</a>
                                    <a href="/vinylFloorClean" class="block px-4 py-2 hover:bg-gray-200">Vinyl COMMERCIAL PLUMBER Service</a>
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://media.licdn.com/dms/image/C5612AQE4triZC5LKNg/article-cover_image-shrink_600_2000/0/1624629611813?e=2147483647&v=beta&t=_kJH_HsRBOg6gHmwtczTbAN4g84QTwYbPn6GCkKWWcI') no-repeat center center fixed; background-size: cover; height: 18.75rem;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 16px; padding-right: 16px; text-align: center; gap: 16px;">
            <h1 style="font-size: 40px; color: white; font-weight: 100; margin-bottom: 24px;">COMMERCIAL PLUMBER Service</h1>
            <p style="font-size: 16px; color: antiquewhite;">Home / Service / Plumbing / COMMERCIAL PLUMBER Service</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://sewerman.com/turkey-city-pa/wp-content/themes/dli-sewerman_rmtheme-child/assets/images/commercial-plumbing-800.jpg" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4">
                            <h4 class="text-xl font-bold text-white">
                                COMMERCIAL PLUMBER Service
                            </h4>
                            <p class="text-md font-light mt-2 text-white">
                                COMMERCIAL PLUMBER Service services include leak repairs, fixture Leakations, and maintenance for efficient water systems in homes and businesses, ensuring reliable operation and minimizing disruptions.
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <TS class="text-xl mb-1 font-semibold">COMMERCIAL PLUMBER Service EXPERTS</TS>
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP COMMERCIAL PLUMBER Service SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our top-to-bottom COMMERCIAL PLUMBER Service service is designed to be fuss-free for you. Besides having your floor cleaned, we also ensure that you have a clear understanding of our COMMERCIAL PLUMBER Service process, enabling you to apply the knowledge to maintain the cleanliness of your floors.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF COMMERCIAL PLUMBER Service SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our COMMERCIAL PLUMBER Service servicing technicians carry out a comprehensive list of COMMERCIAL PLUMBER Service works including floor deep cleaning, vinyl COMMERCIAL PLUMBER Service.
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
            ...
            <div class="flex flex-wrap justify-center -mx-4">
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://media.nedigital.sg/fairprice/fpol/media/images/product/XL/90088986_XL1_20210720.jpg?w=1200&q=70" alt="" class="ml-14 mb-10" style="border: .0625rem solid #f7a80c;padding: .625rem;height: 11.875rem;">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://m.media-amazon.com/images/I/61z1szGx--S._AC_UF894,1000_QL80_.jpg" alt="" class="ml-14 mb-10" style="border: .0625rem solid #f7a80c;padding: .625rem;height: 11.875rem;">
                        <span class="text-primary font-semibold text-lg block mb-4">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://img.kwcdn.com/product/temu-avi/image-crop/fd2455a1-c519-4c33-99b3-2937f0764002.jpg" alt="" class="ml-14 mb-10" style="border: .0625rem solid #f7a80c;padding: .625rem;height: 11.875rem;">
                        <span class="text-primary font-semibold text-lg block mb-4">
    ...
    <!-- COMMERCIAL PLUMBER ServiceATION -->
    <!-- component -->
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden" style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed">Plumbing Services start from $90 per job. See here for full list of our plumbing services prices.
                            ...
                            COMMERCIAL PLUMBER Serviceation Services
                            COMMERCIAL PLUMBER Services Services
                            COMMERCIAL PLUMBER Service Services
                            COMMERCIAL PLUMBER Service Services
                            Toilet Flush System Services
                            COMMERCIAL PLUMBER Services</div>
                    </div>
                </div>
            </li>
        </ul>
