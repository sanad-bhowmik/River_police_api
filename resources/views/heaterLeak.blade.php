...
<body class="bg-white relative">
                        ...
                        <div class="absolute left-0 mt-1 bg-white shadow-lg rounded-lg p-2 hidden group-hover:block z-20" style="width: 340%;">
                            ...
                            <div class="relative group" onmouseover="showSubmenu2()" onmouseout="hideSubmenu2()">
                                ...
                                <div id="fClean-submenu" class="absolute right-full top-0 mt-0 bg-white shadow-lg rounded-lg p-2 hidden-submenu z-20" style="width: 12.5rem;">
                                    ...
                                    <a href="/vinylClean" class="block px-4 py-2 hover:bg-gray-200">Tap Leaking</a>
                                    <a href="/vinylFloorClean" class="block px-4 py-2 hover:bg-gray-200">Vinyl Tap Leak</a>
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://media.istockphoto.com/id/486929190/photo/sink-drip.jpg?s=612x612&w=0&k=20&c=1jhpCvF5LCIM6OkQdcSSGuYzv8uvhB81E_CkUTznPTU=') no-repeat center center fixed; background-size: cover; height: 18.75rem;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 16px; padding-right: 16px; text-align: center; gap: 16px;">
            <h1 style="font-size: 40px; color: white; font-weight: 100; margin-bottom: 24px;">Tap Leak</h1>
            <p style="font-size: 16px; color: antiquewhite;">Home / Service / Plumbing / Tap Leak</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://www.everyworks.com/wp-content/uploads/2020/05/leaking-tap-faucet-leaking-tap-repair-everyworks-plumber-singapore-390x220.jpeg" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4">
                            <h4 class="text-xl font-bold text-white">
                                Tap Leak
                            </h4>
                            <p class="text-md font-light mt-2 text-white">
                                Tap Leak services include leak repairs, fixture Leakations, and maintenance for efficient water systems in homes and businesses, ensuring reliable operation and minimizing disruptions.
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <TS class="text-xl mb-1 font-semibold">Tap Leak EXPERTS</TS>
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP Tap Leak SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our top-to-bottom Tap Leak service is designed to be fuss-free for you. Besides having your floor cleaned, we also ensure that you have a clear understanding of our Tap Leak process, enabling you to apply the knowledge to maintain the cleanliness of your floors.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF Tap Leak SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our Tap Leak servicing technicians carry out a comprehensive list of Tap Leak works including floor deep cleaning, vinyl Tap Leak.
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
            ...
            <div class="flex flex-wrap justify-center -mx-4">
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://wg.scene7.com/is/image/wrenchgroup/water-dripping-mpi23wi001wg?wid=500&$Wrench_New$" alt="" class="ml-14 mb-10" style="border: .0625rem solid #f7a80c;padding: .625rem;height: 11.875rem;">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://media.istockphoto.com/id/1352122726/photo/dripping-kitchen-sink-faucet.jpg?s=612x612&w=0&k=20&c=HBW6aqSiTB5NhTq6JtYGK1Bsi0-jfSzgSQnDbsCCCps=" alt="" class="ml-14 mb-10" style="border: .0625rem solid #f7a80c;padding: .625rem;height: 11.875rem;">
                        <span class="text-primary font-semibold text-lg block mb-4">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4" style="text-align: center;">
                    <div class="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10  px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12 mb-1">
                        <img src="https://cdn.mos.cms.futurecdn.net/bL74JNFDvnoUeBNuveYeJG-415-80.jpg" alt="" class="ml-14 mb-10" style="border: .0625rem solid #f7a80c;padding: .625rem;height: 11.875rem;">
                        <span class="text-primary font-semibold text-lg block mb-4">
