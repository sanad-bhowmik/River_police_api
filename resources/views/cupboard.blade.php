...
<body class="bg-white relative">
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://www.thespruce.com/thmb/MYDMGrk2qAWDKIoSnnTuZgh1sF0=/5414x3609/filters:no_upscale()/how-to-adjust-cabinet-hinges-1822181-01-9518583bf0374f2a8d3b87cadd5fc25f.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">CUPBOARD HINGE</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Handyman / CUPBOARD HINGE</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://m.media-amazon.com/images/I/71ibFjOoMEL._AC_SL1500_.jpg" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4">
                            <h4 class="text-xl font-bold text-white">
                                CUPBOARD HINGE
                            </h4>
                            <p class="text-md font-light mt-2 text-white">
                                CUPBOARD HINGE EXPERTS services include leak repairs, fixture installations, and maintenance for efficient water systems in homes and businesses, ensuring reliable operation and minimizing disruptions.
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <TS class="text-xl mb-1 font-semibold">CUPBOARD HINGE EXPERTS</TS>
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP CUPBOARD HINGE SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF CUPBOARD HINGE SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
                ...
                <div class="w-full px-4">
                    <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
                        <h2 class=" font-bold  text-3xl sm:text-4xl md:text-[40px] text-dark mb-4 ">
                            OUR FULL RANGE OF CUPBOARD HINGE SERVICES INCLUDE
                        </h2>
                    </div>
                </div>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3 p-4 max-w-[400px] md:max-w-[600px] place-items-center">
                <img class="hover:opacity-75" src="https://i.ebayimg.com/images/g/-bEAAOSwNORi6mW7/s-l1600.jpg">
                <img class="hover:opacity-75" src="https://i.ebayimg.com/00/s/MTAwMFgxMDAw/z/ItUAAOSwbnxj8Pl7/$_3.JPG">
                <img class="hover:opacity-75" src="https://www.decorhandles.co.za/cdn/shop/products/soft-closing-cupboard-hinge-full-overlay-652382.jpg?v=1713427236">
            </div>
        </div>
    </section>
    <!-- ====== Pricing Section End -->
    ...
    <section class="text-gray-400 bg-gray-800 body-font mt-10">
        <div class="container px-5 py-24 mx-auto">
            <h1 class="sm:text-3xl text-2xl font-medium title-font text-center text-white mb-20">
                ...
                <br class="hidden sm:block">PROVIDER FOR CUPBOARD HINGE SERVICES
            </h1>
