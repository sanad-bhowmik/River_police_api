...
<body class="bg-white relative">
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://img.staticmb.com/mbcontent/images/crop/uploads/2024/1/wood-polishing_0_1200.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">WOOD POLISHING</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Floor Polishing / WOOD POLISHING</p>
        </div>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                        <img alt="..." src="https://images.squarespace-cdn.com/content/v1/56f2595e8a65e2db95a7d983/1615585078326-JM4WCFRWJ3GO5MSR8LBQ/1483965966_furniturepolishing.jpg?format=1500w" class="w-full align-middle rounded-t-lg">
                        <blockquote class="relative p-8 mb-4">
                            <h4 class="text-xl font-bold text-white">
                                WOOD POLISHING
                            </h4>
                            <p class="text-md font-light mt-2 text-white">
                                WOOD POLISHING consists of applying a protective film to the wood. The application of several layers of film-forming product will create a protective film, which makes your floor resistant to most accidents .
                            </p>
                        </blockquote>
                    </div>
                </div>
                        ...
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">WOOD POLISHING EXPERTS</h6>
                            ...
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">
                                        FULL 1-STOP WOOD POLISHING SERVICES
                                    </h6>
                                    <p class="mb-4 text-blueGray-500">
                                        Our top-to-bottom wood polishing service is designed to be fuss-free for you. Besides providing the wood polishing service, we can also supply the cleaning products and equipment required for the service!
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">RANGE OF POLISHING SERVICES</h6>
                                    <p class="mb-4 text-blueGray-500">
    ...
    <section class="text-gray-400 bg-gray-800 body-font mt-10">
        <div class="container px-5 py-24 mx-auto">
            <h1 class="sm:text-3xl text-2xl font-medium title-font text-center text-white mb-20">
                ...
                <br class="hidden sm:block">PROVIDER FOR PARQUET SERVICES
            </h1>
