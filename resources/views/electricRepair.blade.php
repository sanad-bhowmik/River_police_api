                        ...
                        <div class="absolute left-0 mt-1 bg-white shadow-lg rounded-lg p-2 hidden group-hover:block z-20" style="width: 340%;">
                            ...
                            <div class="relative group" onmouseover="showSubmenu6()" onmouseout="hideSubmenu6()">
                                ...
                                <div id="electric-submenu" class="absolute right-full top-0 mt-0 bg-white shadow-lg rounded-lg p-2 hidden-submenu z-20" style="width: 200px;">
                                    <a href="/electricalRepair" class="block px-4 py-2 hover:bg-gray-200">Electrical Repairation</a>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 h-full">
                <div class="col-span-2 sm:col-span-1 md:col-span-2 bg-gray-50 h-auto md:h-full flex flex-col">
                    <a href="" class="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 flex-grow">
                        <img src="https://media.istockphoto.com/id/1345765714/photo/electrical-engineers-test-electrical-Repairations-and-wiring-on-protective-relays-measuring.jpg?s=612x612&w=0&k=20&c=Go95zj7drMZVNTaPS615U5Yjsl_y1cvTHqoyJirLMlA=" alt="" class="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out">
    ...
    <div class="py-24 px-8 max-w-5xl mx-auto flex flex-col md:flex-row gap-12 mt-10">
        ...
        <ul class="basis-1/2">
            <li>
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden" style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed">Whether it comes to broken pipes, leaky faucets, or clogged drains, it is best to call up a professional Singapore Electrical Repair who has the license, skills, tools and expertise to deal with the task. Here are some things to consider before looking to engage a Electrical Repair.
                            License / Accreditations
                            A PUB license is important for big plumbing projects, especially for HDB or commerciarenovations that require hacking into the plumbing systems. However, most Electrical Repairs should bBCA-licensed for common domestic plumbing works like solving water leaks and water pipe works.
                            Experience
                            Looking for an experienced Electrical Repair is key if you do not want the plumbing issue they are fixinto come back again. A Electrical Repair who is confident in their skills is equivalent to how many yearthey have been working in the industry.
                            ...
                            Warranty
                            Look at Singapore Electrical Repair services that offers plumbing works with workmanship or servicwarranty, and check if the warranty is extended to the plumbing products as well.
                        </div>
                    </div>
                </div>
            </li>
            <li>
                ...
                <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden" style="transition: max-height 0.3s ease-in-out 0s;">
                    <div class="pb-5 leading-relaxed">
                        <div class="space-y-2 leading-relaxed">Plumbing emergencies do happen, and calling a Electrical Repair will be necessary. But you can certainly save money on plumbing works by preventing them from disrepair in the first place. Just follow these easy steps:
                            ...
                            Compare prices
                            Plumbing is a competitive business, and many different companies offer different plumbing services at differing prices. Make sure you do your own research in order to compare prices and find the right Electrical Repair who can do the job well for you.</div>
                    </div>
                </div>
            </li>
            <li>
