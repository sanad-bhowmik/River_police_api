...
<body class="bg-white relative">
    ...
    <section class="parallax mt-16" style="position: relative; background: url('https://www.tmsupply.com/wp-content/uploads/2023/03/Care-Maint-Mopping.jpg') no-repeat center center fixed; background-size: cover; height: 300px;">
        ...
        <div class="content" style="position: relative; z-index: 1; display: flex; flex-direction: column; padding-left: 1rem; padding-right: 1rem; text-align: center; gap: 1rem;">
            <h1 style="font-size: 2.5rem; color: white; font-weight: 100; margin-bottom: 1.5rem;">Terrazzo Floor Clean</h1>
            <p style="font-size: 1rem; color: antiquewhite;">Home / Service / Floor Clean / Terrazzo Floor Clean</p>
        </div>
    </section>
